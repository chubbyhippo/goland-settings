...
"$HOME"/AppData/Roaming/JetBrains/GoLand* \
...
# install plugins
curl -k https://raw.githubusercontent.com/chubbyhippo/goland-settings/refs/heads/main/install-plugins.sh | /usr/bin/env sh
